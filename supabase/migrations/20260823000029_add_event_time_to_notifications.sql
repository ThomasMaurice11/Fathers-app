-- ============================================================
-- 000029: optional event_time on notifications (general events)
-- ============================================================

alter table public.notifications
  add column if not exists event_time time null;

comment on column public.notifications.event_time is
  'Optional clock time for a general event; null means all-day / unspecified.';

-- Include event_time in dashboard general-events payload and sort by it.
