-- ============================================================
-- 000015: marriage_contract on children (nullable date)
-- ============================================================

alter table public.children
  add column if not exists marriage_contract date null;
...
as $$
  ...
  select
    c.id, c.first_name, c.last_name, c.birthday, c.marriage_contract,
...
-- get_child_detail() — returns json, safe to replace
