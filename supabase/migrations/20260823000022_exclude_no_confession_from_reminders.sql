-- ============================================================
-- 000022: do not treat missing confession as needing reminder
-- Only children with a recorded confession older than 27 days
-- are flagged needs_confession / returned in confession reminders.
-- ============================================================
